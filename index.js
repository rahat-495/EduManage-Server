...
//     //   const {email} = req.query ;
//     //   const result = await schoolsCollection.find({email}) ;
//     //   res.send(result) ;
//     // })

//     // app.get('/yourClasses' , async (req , res) => {
//     //   const {email} = req.query ;
//     //   const result = await classesCollection.find({email}) ;
//     //   res.send(result) ;
//     // })

//     // app.get('/schoolsDetails' , async (req , res) => {
//     //   const {id} = req.query ;
//     //   const result = await schoolsCollection.findOne({_id : id)}) ;
//     //   res.send(result) ;
//     // })

//     // app.get('/subjects' , async (req , res) => {
//     //   const {id} = req.query ;
//     //   const result = await classesCollection.findOne({_id : id)}) ;
//     //   res.send(result) ;
//     // })
...
//     //   const {id} = req.query ;
//     //   const school = await schoolsCollection.findOne({_id : id)}) ;
//     //   const classes = school?.grades?.map((classId) => classId ))
//     //   const result = await classesCollection.find({_id : {$in : classes}}) ;
//     //   res.send(result) ;
//     // })

//     // to get the all schools data for show schools -----------
//     // app.get('/allSchools' , async (req , res) => {
//     //   const result = await schoolsCollection.find() ;
//     //   res.send(result) ;
//     // })
...
//     //   if(schoolId){
//     //     const school  = await schoolsCollection.findOne({_id : schoolId )}) ;
//     //     const classesId = school?.classes?.map((id) => id)) ;
//     //     const classes = await classesCollection.find({ _id : { $in : classesId } }) ;
//     //     res.send(classes) ;
//     //   }
//     // })
...
//     //   const {uid} = req.query ;
//     //   const result = await addmissionsCollection.find({studentUid : uid}) ;
//     //   res.send(result) ;
//     // })
...
//     //   const {email} = req.query ;
//     //   const schoolData = await schoolsCollection.find({email}) ;
//     //   const gradesData = await classesCollection.find({email}) ;
//     //   const schoolId = schoolData.map((data) => data?._id) ;
//     //   const school = await addmissionsCollection.find({ schoolId: { $in: schoolId } }) ;
//     //   res.send(school) ;
//     // })
...
//     //   const {email} = req.query ;
//     //   const schoolsData = await schoolsCollection.find({email}) ;
//     //   const schoolsId = schoolsData?.map((school) => school?._id.toHexString()) ;
//     //   const allStudents = await studentsCollection.find({ schoolId : { $in : schoolsId } }) ;
...
//     //     const data = req.body ;
//     //     const result = await schoolsCollection.create(data) ;
...
//     //   const addClass = await classesCollection.create(classData) ;
...
//     //   const {gradeNumber} = await classesCollection.findOne({_id : addmissionData?.grade )}) ;
...
//     //     const result = await addmissionsCollection.create(addmissionData) ;
...
//     // app.put('/updateAddmission' , async (req , res) => {
//     //   const {id} = req.query ;
//     //   const data = req.body ;
//     //   const result = await addmissionsCollection.updateOne({_id : id)} , { $set : { ...data } })
//     //   res.send(result) ;
//     // })
...
//     //   const result = await schoolsCollection.updateOne({_id : id)} , { $set : { ...updatedData } }) ;
//     //   res.send(result)
//     // })
...
//     //   }
//     //   else{
//     //     const user = await usersCollection.findOne({_id : isAxist?._id )}) ;
//     //     return res.send(user) ;
//     //   }
//     // })
...
//     //   const addmissionData = await addmissionsCollection.findOne({_id : id )}) ;
...
//     //         await addmissionsCollection.updateOne({_id : id )} , { $set : { isjoined : true } }) ;
//     //         await usersCollection.updateOne({studentUid : addmissionData?.studentUid } , { $set : { isjoined : addmissionData?.schoolId , isjoinedModalSeen : false } }) ;
//     //         if(!isStudentAxist?.studentEmail){
//     //           await studentsCollection.create({ ...addmissionData , schoolJoiningStatus : true , gradeJoiningStatus : true , isjoined : true , date : new Date().toDateString() , filteringDate : new Date().toLocaleDateString() })
//     //         }
//     //       }
//     //       if(addmissionData?.gradeJoiningStatus === 'rejected' && addmissionData?.schoolJoiningStatus === 'rejected'){
//     //         await addmissionsCollection.updateOne({_id : id )} , { $set : { isjoined : false } }) ;
//     //       }
//     //       const result = await addmissionsCollection.updateOne({_id : id )} , { $set : { schoolJoiningStatus } }) ;
//     //       return res.send(result) ;
//     //     }
...
//     //         await addmissionsCollection.updateOne({_id : id )} , { $set : { isjoined : false } }) ;
//     //       }
//     //       const result = await addmissionsCollection.updateOne({_id : id )} , { $set : { gradeJoiningStatus } }) ;
//     //       return res.send(result) ;
//     //     }
...
//     //   const {id} = req.body ;
//     //   const result = await addmissionsCollection.updateOne({_id : id )} , { $set : { schoolJoiningStatus : 'pending' , gradeJoiningStatus : 'pending' , isjoined : false } }) ;
//     //   res.send(result) ;
//     // })
