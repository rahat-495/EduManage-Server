...
const updateDevice = async (req , res) => {
    try {
        ...
        if(userData?.email){
            ...
            if(date?.loginDate !== data?.devicesInfo?.loginDate || os?.deviceName === data?.devicesInfo?.deviceName){
            ...
            else if(os?.deviceName !== data?.devicesInfo?.deviceName || date?.loginDate === data?.devicesInfo?.loginDate){
